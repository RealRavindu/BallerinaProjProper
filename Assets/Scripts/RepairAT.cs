...
namespace NodeCanvas.Tasks.Actions {
	...
	public class RepairAT : ActionTask {
		...
		protected override void OnExecute() {
			...
			if (lightHouseblackboard == null) Debug.Log("AAAAAAAAAAAAAAAAAAAAA");
			//EndAction(true);
		}
		...
		protected override void OnUpdate() {
			...
			repairValue += rateOfRepair * Time.deltaTime;
			lightHouseblackboard.SetVariableValue("repairValue", repairValue);

			if(repairValue > lightHouseblackboard.GetVariableValue<float>("activeThreshold")) EndAction(true);
		}
